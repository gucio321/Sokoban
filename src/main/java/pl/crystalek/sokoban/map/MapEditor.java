...
import pl.crystalek.sokoban.map.convert.ConvertGridPaneToString;
import pl.crystalek.sokoban.map.convert.ConvertStringToGridPane;
import pl.crystalek.sokoban.map.listener.BoxListenerManager;
...
public final class MapEditor {
    ...
    public MapEditor(final MainLoader mainLoader) {
        ...
        this.convertGridPaneToString = new ConvertGridPaneToString(mainLoader, this);
    ...
    public void openCreator() {
        ...
        for (int rowNumber = 0; rowNumber < 20; rowNumber++) {
            for (int columnNumber = 0; columnNumber < 30; columnNumber++) {
                ...
                boxLocationList.add(new BoxLocation(columnNumber * 39 + 19 + OFFSET_X, rowNumber * 39 + 19 + OFFSET_Y, columnNumber, rowNumber, boxPane));
